...
#define TAG "MovecallMoji2ESP32S3"
...
class MovecallMoji2ESP32S3 : public WifiBoard {
private:
...
public:
    MovecallMoji2ESP32S3() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeCodecI2c();
...
DECLARE_BOARD(MovecallMoji2ESP32S3);
